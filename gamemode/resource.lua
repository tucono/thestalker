...
resource.AddFile( "materials/stalker/vision.vmt" )
...
resource.AddFile( "materials/nuke/gore1.vmt" )
resource.AddFile( "materials/nuke/gore2.vmt" )

resource.AddFile( "resource/fonts/slippy.ttf" )
resource.AddFile( "resource/fonts/prototype.ttf" )

resource.AddFile( "sound/nuke/heartbeat.wav" )
resource.AddFile( "sound/nuke/gore/blood01.wav" )
resource.AddFile( "sound/nuke/gore/blood02.wav" )
resource.AddFile( "sound/nuke/gore/blood03.wav" )
